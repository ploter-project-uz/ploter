 ...
 */
RepStepper::RepStepper(int number_of_steps, int dir_pin, int step_pin, int enable_pin)
{
...
void RepStepper::pulse()
{
  ...
  delayMicroseconds(1000); //make sure it stabilizes... for opto isolated stepper drivers.
