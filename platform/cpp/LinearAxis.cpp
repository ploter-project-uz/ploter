...
LinearAxis::LinearAxis(char id, int steps, int dir_pin, int step_pin, int min_pin, int max_pin, int enable_pin)
  : stepper(steps, dir_pin, step_pin, enable_pin)
{
...
void LinearAxis::setTarget(long t)
{
  ...
  this->delta = std::abs(this->target - this->current);
